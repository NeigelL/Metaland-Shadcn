    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Metaland Sales Manager Portal Logo",
      },
    ],
    type: "website",
  },
    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <Providers
          ...
          accountType="salesmanager"
          callbackURL={["https://", process.env.NEXT_SALES_MANAGER_DOMAIN || "salesmanager.metaland.properties"].join("")}
        >
          {children}
        </Providers>
