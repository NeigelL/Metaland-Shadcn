          ...
          <CardContent className="grid gap-4">
            ...
            {loginType === 'google' &&
              <>
                <button
                  onClick={handleLogin}
                  className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 px-4 border border-gray-300 rounded-lg shadow-sm transition-all duration-200 text-sm md:text-base  cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full text-blue-600 hover:text-blue-700 font-medium py-2 px-4 rounded-lg text-sm md:text-base transition-colors duration-200 cursor-pointer"
                >
                  Sign in with Email
                </button>
              </>
